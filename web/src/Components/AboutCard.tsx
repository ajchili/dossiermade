      ...
      <div>
        <div className="uk-visible@m uk-child-width-1-2" uk-grid="true">
          <Card
            ...
            content={
              <p>
                ...
                Southern Virginia. Arrangements can also be made to travel
                further along the east coast and to other North American
                Locations.
              </p>
            }
          />
          <Card
            ...
            content={
              <p>
                To construct a showcase for anyone who’s desire is to display
                what they want, when they want, wherever they want. Currently,
                we are dedicated to the automotive performance and aesthetic
                communities, with room to venture into many different avenues
